...
| Drag-and-drop texture import (grid tile & morph portal) | `TEXTURE:DROP_IMPORT` IPC (`Services/IpcContracts.cs` · `TextureDropImportPayload`); frontend: `frontend/src/components/grid/WorkspaceTileCard.tsx`, `frontend/src/components/grid/TileHoverMorphPortal.tsx`, `useIpc.dropImportTexture` |
