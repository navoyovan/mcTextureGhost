...
public record PackStatsDto(
    ...
    [property: JsonPropertyName("entitiesGhostCount")] int EntitiesGhostCount,
...
public record TextureAliasDto(
    ...
    [property: JsonPropertyName("hasAtlas")] bool HasAtlas = false,
    [property: JsonPropertyName("atlasFullPath")] string? AtlasFullPath = null,
...
public static class IpcContractMapper
{
    ...
    public static TextureAliasDto ToDto(this TextureAlias alias, string? packRoot = null)
    {
        ...
        return new TextureAliasDto(
            ...
            HasAtlas: alias.HasAtlas,
            AtlasFullPath: alias.AtlasFullPath,
            Key: alias.Alias,
    ...
    public static CatalogLeafDto ToDto(this CatalogLeaf leaf, string? packRoot = null)
    {
        ...
        return new CatalogLeafDto(
            ...
            Weight: leaf.Weight,
            HasMers: leaf.HasMers,
            MersFullPath: leaf.MersFullPath,
            HasAtlas: leaf.HasAtlas,
            AtlasFullPath: leaf.AtlasFullPath,
    ...
    public static PackStatsDto ExtractStats(this MainViewModel vm)
    {
        ...
        return new PackStatsDto(
            ...
            EntitiesCount: vm.EntitiesTotalCount,
            BlocksGhostCount: vm.BlocksGhostCount,
            ItemsGhostCount: vm.ItemsGhostCount,
            EntitiesGhostCount: vm.EntitiesGhostCount,
            Total: total,
            Done: ok,
            Ghosts: ghost,
            Orphans: orphan
